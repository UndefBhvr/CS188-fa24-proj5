...
class RegressionModel(Module):
    ...
    def train(self, dataset):
        ...
        op = optim.Adam(self.parameters(), lr=0.0001)
...
class DigitClassificationModel(Module):
    ...
    def __init__(self):
        ...
        output_size = 10
        "*** YOUR CODE HERE ***"
        self.f1 = Linear(input_size, 256)
        self.f2 = Linear(256, 128)
        self.o = Linear(128, output_size)
...
class LanguageIDModel(Module):
    ...
    def __init__(self):
        ...
        "*** YOUR CODE HERE ***"
        self.h = 512
        self.f1 = Linear(self.num_chars, self.h)
        self.f2 = Linear(self.h, self.h)
        self.o = Linear(self.h, len(self.languages))
    ...
    def run(self, xs):
        ...
        "*** YOUR CODE HERE ***"
        n = len(xs)
        res = relu(self.f1(xs[0]))
        for i in range(1, n):
            res = relu(self.f1(xs[i])) + relu(self.f2(res))
        return self.o(res)
...
def Convolve(input: tensor, weight: tensor):
    ...
    r = input_tensor_dimensions[0] - weight_dimensions[0] + 1
    c = input_tensor_dimensions[1] - weight_dimensions[1] + 1
    k = weight_dimensions[0]
    Output_Tensor = ones((r, c))
    for i in range(r):
        for j in range(c):
...
class DigitConvolutionalModel(Module):
    ...
    def __init__(self):
        ...
        input_size = 26**2
        self.h = 512
        self.f1 = Linear(input_size, self.h)
        self.f2 = Linear(self.h, self.h)
        self.o = Linear(self.h, output_size)
...
class Attention(Module):
    ...
    def forward(self, input):
        ...
        score:torch.Tensor = torch.matmul(K, Q.transpose(1, 2)) / self.layer_size**0.5
        score = score.masked_fill(self.mask[:,:,:T,:T] == 0, float("-inf"))[0]
        probs = softmax(score, -1)
